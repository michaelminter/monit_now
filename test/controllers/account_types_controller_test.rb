...
class AccountTypesControllerTest < ActionController::TestCase
  ...
  test "should create account_type" do
    assert_difference('AccountType.count') do
      post :create, account_type: { data_limit: @account_type.data_limit, data_retention: @account_type.data_retention, name: @account_type.name, price: @account_type.price }
    end
  ...
  test "should update account_type" do
    patch :update, id: @account_type, account_type: { data_limit: @account_type.data_limit, data_retention: @account_type.data_retention, name: @account_type.name, price: @account_type.price }
    assert_redirected_to account_type_path(assigns(:account_type))
  end
